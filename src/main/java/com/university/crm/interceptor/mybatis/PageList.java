...
public class PageList<E> extends ArrayList<E> {
    ...
    public PageList(Page page, boolean count, boolean isSort) {
        this(page.getPageNumber(), page.getPageSize(), page.getSort(), page.getOrder(), count ? PageList.SQL_COUNT : PageList.NO_SQL_COUNT, isSort);
    }

    public PageList(int pageNum, int pageSize, boolean count) {
        this(pageNum, pageSize, null, null, count ? PageList.SQL_COUNT : PageList.NO_SQL_COUNT, false);
    }

    public PageList(int pageNum, int pageSize, String sortField, String orderBy, int total, boolean isSort) {
